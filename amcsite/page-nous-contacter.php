...
<div class="row container contact-content" style="margin-top:2em">
        <div class="col m6 s12 contact-info">
            ...
            <ul>
                <li style="margin:.8em auto;"><i class="fa fa-home"></i> <span>Sicap Amitié 3 – N° 4435, BP 15708 <br>Dakar-Fann Sénégal</span></li>
                <li style="margin:.8em auto;"><i class="fa fa-phone"></i> <span>+221 33 859 75 00</span></li>
                <li style="margin:.8em auto;"><i class="fa fa-envelope"></i> <a style="color: inherit;" href="mailto:administration@afriquemanagementconseil.com">administration@afriquemanagementconseil.com</a></li>
                <li style="margin:.8em auto;"><i class="fa fa-linkedin-square" aria-hidden="true"></i> <a style="color: inherit;" href="https://www.linkedin.com/company/afrique-management-conseil" target="_blank">Afrique Management conseil</a></li>
