...
?>
   <div id="home"  class="scrollspy main-content">
       <img class="responsive-img" src="<?= get_template_directory_uri().'/assets/img/header_image.jpg' ;?>" alt="Header Image">
   </div>
...
$get_experts = wp_count_posts('intervention');
            ...
            while ( $domain->have_posts() ) : $domain->the_post();
                ...
                <div class="col s12 m6 l4 box">
                    <div class="white wow fadeIn" data-wow-delay="1s" style="padding: 10px 15px; position:relative">
                        <a class="box-link" href="<?php the_permalink();?>"></a>
...
<div id="reference"  class="section scrollspy row white">
